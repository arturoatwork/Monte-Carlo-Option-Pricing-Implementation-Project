...
In practice this shows up as price estimates stabilizing and confidence intervals tightening as N grows.
...
Stochastic volatility (e.g. Heston) and jump-diffusion models address some of these gaps.
